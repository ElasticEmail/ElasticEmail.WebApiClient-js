...
var uploadPostFile = function uploadPostFile(target, fileObj, query, callback) {
    ...
    domain.Add = function (domain, trackingType, callback) {
        trackingType = typeof trackingType !== 'undefined' ? trackingType : 'nohttps';
     ...
     * @return {ExportStatus}
     */
    eksport.CheckStatus = function (publicExportID, callback) {
     ...
     */
    eksport.CountByType = function (callback) {
     ...
     * @param {Function} callback
     */
    eksport.Delete = function (publicExportID, callback) {
     ...
     * @return {Array.<Export>}
     */
    eksport.List = function (limit, offset, callback) {
        limit = typeof limit !== 'undefined' ? limit : 0;
        offset = typeof offset !== 'undefined' ? offset : 0;
